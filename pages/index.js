        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 40, flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              <h2 className="sec-title" style={{ fontSize: 36, fontWeight: 900, color: "#fff", margin: "0 0 8px" }}>
                Emporio <span style={{ color: "#C8102E" }}>Blindaje Legal</span>
              </h2>
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.55)", margin: 0, maxWidth: 480, lineHeight: 1.6 }}>
                Renta tu inmueble con protección jurídica total. Investigamos al candidato, elaboramos el contrato y te respaldamos si algo falla.
              </p>
            </div>
            <a href="/blindaje-legal" style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "#fca5a5", fontWeight: 700, fontSize: 14, textDecoration: "none", whiteSpace: "nowrap" }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
            <a href="/blindaje-legal" style={{ background: "#C8102E", color: "#fff", padding: "13px 24px", borderRadius: 10, fontWeight: 800, fontSize: 14, textDecoration: "none" }}>
              🛡️ Conocer Emporio Blindaje Legal
            </a>
            <a href="https://app.emporioinmobiliario.com.mx/registro-propietario" target="_blank" rel="noreferrer"
              style={{ background: "rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.8)", padding: "13px 24px", borderRadius: 10, fontWeight: 700, fontSize: 14, textDecoration: "none", border: "1px solid rgba(255,255,255,0.15)" }}>
      ...
      <div className="sec-pad" style={{ padding: "72px 32px", background: "#C8102E", textAlign: "center" }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href="https://app.emporioinmobiliario.com.mx/propiedades"
