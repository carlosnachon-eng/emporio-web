...
const PASOS = [
  { num: "01", icon: "🏠", title: "Nos compartes tu propiedad", desc: "Cuéntanos los detalles y agendamos una visita sin compromiso." },
  { num: "02", icon: "📸", title: "Fotos y publicación", desc: "Tomamos fotos y publicamos en redes y portales especializados." },
  { num: "03", icon: "💬", title: "Filtramos interesados", desc: "Atendemos clientes, filtramos a los más serios y coordinamos visitas." },
  { num: "04", icon: "📝", title: "Firma de contrato", desc: "Firmamos el contrato con asesoría legal para protegerte." },
  { num: "05", icon: "💰", title: "Tú cobras", desc: "Recibes tu renta o venta y nosotros cobramos nuestra comisión." },
];
  ...
  const handleEnviar = async () => {
    ...
    try {
      await fetch("/api/send-email", {
        ...
        body: JSON.stringify({ ...form, asunto: "Nuevo propietario interesado" }),
      });
      setEnviado(true);
          ...
          {enviado ? (
            ...
            <div style={{ background: "#fff", borderRadius: 20, padding: "48px 40px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, marginBottom: 20 }}>
                ...
                <div>
                  <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#374151", marginBottom: 6 }}>Venta o Renta</label>
