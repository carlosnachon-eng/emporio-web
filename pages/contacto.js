...
export default function Contacto() {
  ...
  return (
    <div style={{ fontFamily: "'Montserrat', sans-serif", background: "#fff" }}>
      ...
      <div style={{ padding: "80px 32px", background: "#f8f8fa" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "start" }}>
            ...
            <div>
              ...
              <h1 style={{ fontSize: 44, fontWeight: 900, color: "#1a1a2e", margin: "0 0 20px", lineHeight: 1.1 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
                {[
                  ...
                  <div key={c.label} style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                    <div style={{ width: 44, height: 44, borderRadius: 12, background: "rgba(200,16,46,0.08)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20, flexShrink: 0 }}>{c.icon}</div>
                    <div>
                ...
                <div style={{ display: "flex", gap: 12 }}>
                  {[
                    ...
                    <a key={s.label} href={s.href} target="_blank" rel="noreferrer" style={{
                      width: 40, height: 40, borderRadius: 10, background: "#1a1a2e", color: "#fff",
            ...
            {/* Formulario */}
            <div style={{ background: "#fff", borderRadius: 20, padding: "40px 36px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
              ...
              {enviado ? (
                ...
                <>
                  ...
                  <button onClick={handleEnviar} disabled={enviando || !form.nombre || !form.whatsapp}
                    style={{ width: "100%", background: "#C8102E", color: "#fff", border: "none", borderRadius: 12, padding: "14px", fontWeight: 800, fontSize: 15, cursor: enviando ? "not-allowed" : "pointer", opacity: enviando ? 0.7 : 1, fontFamily: "'Montserrat', sans-serif" }}>
                    {enviando ? "Enviando..." : "Enviar mensaje →"}
                  </button>

                  <a href="https://wa.me/522222573237" target="_blank" rel="noreferrer" style={{
                    display: "block", width: "100%", background: "#25d366", color: "#fff", borderRadius: 12, padding: "14px",
                    fontWeight: 800, fontSize: 15, textAlign: "center", textDecoration: "none", marginTop: 12, boxSizing: "border-box",
                  }}>
