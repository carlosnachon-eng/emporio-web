export const LEAD_ENGINE_ENV = Object.freeze({
  ...
  testHmacSecret: "LEAD_ENGINE_TEST_HMAC_SECRET",
});
 ...
 * @property {"production"|"preview"|"development"|null} environment
 * @property {"production"|"preview"|"development"|null} deploymentEnvironment
