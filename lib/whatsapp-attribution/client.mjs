...
const DEFAULT_PILOT_ENABLED = process.env.NEXT_PUBLIC_WHATSAPP_ATTRIBUTION_PILOT_ENABLED;
...
export function whatsappAttributionEnabled(env = null) {
  const value = env
    ? env.NEXT_PUBLIC_WHATSAPP_ATTRIBUTION_PILOT_ENABLED
    : DEFAULT_PILOT_ENABLED;
