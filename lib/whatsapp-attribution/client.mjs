...
const DEFAULT_ATTRIBUTION_ENABLED = process.env.NEXT_PUBLIC_WHATSAPP_ATTRIBUTION_ENABLED;
...
export function whatsappAttributionEnabled(env = null) {
  const value = env
    ? env.NEXT_PUBLIC_WHATSAPP_ATTRIBUTION_ENABLED
    : DEFAULT_ATTRIBUTION_ENABLED;
