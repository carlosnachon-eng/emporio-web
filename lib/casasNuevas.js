...
export const CASAS_NUEVAS = [
  {
    ...
    imagen: "/images/casas-nuevas/granjas/fachada-general.jpg",
    imagenes: [
      "/images/casas-nuevas/granjas/fachada-general.jpg",
      "/images/casas-nuevas/granjas/casa-interior.jpg",
    ...
    caracteristicas: [
      "Desde 80 m2 de terreno",
      "Desde 127 m2 de construcción",
  ...
  },
  {
    ...
    descripcion:
      "Colección de casas nuevas en Bugambilias, Puebla, actualmente en etapa final de acabados. El grupo permite comparar las unidades disponibles en una sola página y entrar después a la ficha individual de cada propiedad.",
    resumen:
      "Dos casas nuevas próximas a entrega, con roof garden, acabados en proceso final y fichas individuales por unidad.",
    caracteristicas: [
      "Casas nuevas en venta",
      "Unidades de distribución similar",
